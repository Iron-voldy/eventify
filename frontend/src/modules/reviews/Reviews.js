...
const Reviews = ({ navigation }) => {
  ...
  const validateComment = (comment, setError) => {
    const trimmed = comment.trim();
    if (!trimmed) { setError('Comment is required'); return false; }
    if (trimmed.length < 10) { setError('Comment must be at least 10 characters'); return false; }
    if (trimmed.length > 500) { setError('Comment must be 500 characters or fewer'); return false; }
    setError('');
    return true;
  };
  ...
  const handleCreateReview = async () => {
    ...
    if (!validateComment(createComment, setCreateCommentError)) return;
  ...
  const handleSaveEdit = async () => {
    if (!validateComment(editComment, setEditCommentError)) return;
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            ...
            <CustomInput
              ...
              value={createComment}
              onChangeText={(t) => { setCreateComment(t); setCreateCommentError(''); }}
              multiline
              numberOfLines={5}
        ...
        <View style={styles.modalContainer}>
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            ...
            <CustomInput
              ...
              placeholder="Share your experience..."
              value={editComment}
              onChangeText={(t) => { setEditComment(t); setEditCommentError(''); }}
              multiline
              numberOfLines={5}
